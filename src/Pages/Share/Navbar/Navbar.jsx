...
const Navbar = () => {
    ...
    const navOption = <>
        ...
        <li> <Link to="/"><a className='hover:text-white'>Detail Food</a></Link> </li>

        <li> <Link to="/"><a className='hover:text-white'>Share Receipe</a></Link> </li>

        {
            user ? <li><button onClick={handleLogOut}>Log Out</button></li> : <li> <Link to="/login"><a className='hover:text-white'>Log In</a></Link> </li>
        }
